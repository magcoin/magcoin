...
static const int64 MIN_TX_FEE = 1000000; //0.01 minimum TX fee
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 250000000 * COIN; // 2.5 bn, maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 360 / 250; // 360 blocks found a day. Priority cutoff is 100 MAG day / 250 bytes.
    }
