#############################################################################
# Makefile for building: magcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Aug 5 22:07:50 2014
# Project:  magcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -o Makefile magcoin-qt.pro
#############################################################################
...
Makefile: magcoin-qt.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile magcoin-qt.pro
